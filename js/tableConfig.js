...
// (label, tipe data, apakah bisa di-sort)
// ======================================================
...
const RESERVATION_COLUMNS = [
    ...
    { key: "nights", label: "Nights", type: "text", sortable: false },
    ...
    { key: "check_in_at", label: "Check-in At", type: "datetime" },
    { key: "check_out_at", label: "Check-out At", type: "datetime" },
    ...
    { key: "billing_items", label: "Billing Items", type: "text" },
...
// Default: SEMUA kolom tampil, urutan sesuai array di atas
